...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(sn.groupeisi.findjob..*)" +
            " || within(sn.groupeisi.findjob.controller..*)" +
            " || within(sn.groupeisi.findjob.security.controller..*)")
    ...
    @Around("execution(* sn.groupeisi.findjob.service..*(..)))")
